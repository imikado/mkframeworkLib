 ...
 */
class sgbd_syntax_mssqlTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_getListColumnShouldFinishOk()
    {
        ...
        $oSgbdSyntax=new sgbd_syntax_mssql();
    ...
    {
        $sTable='myTable';
        $sExpectedReturn= "SELECT table_name FROM information_schema.tables WHERE table_type='BASE TABLE'";
    ...
    {
        $sExpectedReturn= 'SELECT SCOPE_IDENTITY()';
