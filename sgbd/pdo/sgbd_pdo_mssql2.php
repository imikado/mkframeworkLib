...
*/
class sgbd_pdo_mssql2 extends abstract_sgbd_pdo{
	...
	public function getListColumn($sTable){
		$pRs=$this->query(sgbd_syntax_mssql2::getListColumn($sTable));
		$tObj=array();
	...
	public function getListTable(){
		$pRs=$this->query(sgbd_syntax_mssql2::getListTable());
	...
	public function getLastInsertId(){
		$pRs=$this->query(sgbd_syntax_mssql2::getLastInsertId());
